...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Scripted By Sparky','Fight The Storm','FTS System','FTS UP','SUB TO KAKASHI','/help'];
    var i = -1;
    var j = 0;
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``My ID``' , `[ ${client.user.id} ]` , true)
			      ...
			      .addField('``Scripted by``' , `[ Sparky ]` , true)
			      .setFooter('By | Sparky')
    })
}
});
...
return channel.send("")
  ...
  if (message.content.toLowerCase().startsWith(prefix + `thelp`)) {
    const embed = new Discord.RichEmbed()
    .setTitle(`:mailbox_with_mail: FTS Ticket Help`)
    .setColor(0xCF40FA)
    .setDescription(`Hello! I'm Fts Ticket, the Discord bot for super cool support ticket stuff and more! Here are my commands:`)
    .addField(`Tickets`, `[${prefix}new]() > Opens up a new ticket and tags the Support Team\n[${prefix}close]() > Closes a ticket that has been resolved or been opened by accident`)
    .addField(`Other`, `[${prefix}help]() > Shows you this help menu your reading\n[${prefix}ping]() > Pings the bot to see how long it takes to react\n[${prefix}about]() > Tells you who scripted me`)
    message.channel.send({ embed: embed });
  }
